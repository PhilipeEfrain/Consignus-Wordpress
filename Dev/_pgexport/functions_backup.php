...
function site_consignus_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'a_consignus_imagem01', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'a_consignus_imagem01', array(
    ...
    $wp_customize->add_setting( 'a_consignus_texto01', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'a_consignus_texto01', array(
        'label' => __( 'Texto 01', 'site_consignus' ),
        'type' => 'textarea',
        'section' => 'a_consignus'
    ));
...
if ( ! function_exists( 'site_consignus_enqueue_scripts' ) ) :
    ...
    wp_deregister_script( 'site_consignus-plugins' );
    wp_enqueue_script( 'site_consignus-plugins', get_template_directory_uri() . '/components/pg.blocks/js/plugins.js', false, null, true);

    wp_deregister_script( 'site_consignus-bskitscripts' );
    wp_enqueue_script( 'site_consignus-bskitscripts', get_template_directory_uri() . '/components/pg.blocks/js/bskit-scripts.js', false, null, true);

    wp_deregister_script( 'site_consignus-script' );
    wp_enqueue_script( 'site_consignus-script', 'https://maps.google.com/maps/api/js?sensor=true', false, null, true);
    ...
    wp_deregister_style( 'site_consignus-blocks' );
    wp_enqueue_style( 'site_consignus-blocks', get_template_directory_uri() . '/components/pg.blocks/css/blocks.css', false, null, 'all');

    wp_deregister_style( 'site_consignus-plugins' );
    wp_enqueue_style( 'site_consignus-plugins', get_template_directory_uri() . '/components/pg.blocks/css/plugins.css', false, null, 'all');

    wp_deregister_style( 'site_consignus-stylelibrary' );
    wp_enqueue_style( 'site_consignus-stylelibrary', get_template_directory_uri() . '/components/pg.blocks/css/style-library-1.css', false, null, 'all');

    wp_deregister_style( 'site_consignus-style-1' );
    wp_enqueue_style( 'site_consignus-style-1', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,300,600,700', false, null, 'all');

    wp_deregister_style( 'site_consignus-style-2' );
    wp_enqueue_style( 'site_consignus-style-2', 'http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic', false, null, 'all');
