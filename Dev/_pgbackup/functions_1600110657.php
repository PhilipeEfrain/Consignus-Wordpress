...
if ( ! function_exists( 'site_consignus_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'site_consignus-style', 'https://fonts.googleapis.com/css?family=Raleway:200,100,400', false, null, 'all');
    ...
    wp_enqueue_style( 'site_consignus-style-1', get_bloginfo('stylesheet_url'), false, null, 'all');
